...
if (!title.trim() || !genre.trim() || !country.trim() || !releaseDate.trim()) {
...
const payload: MovieCredentials = { title: title.trim(), genre: genre.trim(), country: country.trim(), releaseDate: releaseDate.trim() };
...
return (
  <div className=" border-emerald-200 rounded-2xl p-6 shadow-md max-w-md mx-auto mt-4 bg-gradient-to-br from-cream-20 to-orange-100">
    <h3 className="text-2xl font-semibold text-emerald-900 mb-4">Add a movie</h3>
